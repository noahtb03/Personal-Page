...
function ContactPage() {
  ...
  const handleSubmit = () => {
    ...
    const mailto =
      `mailto:noahtimothybennett@gmail.com` +
            ...
            <div>
              ...
              >
                ...
                <div style={{ fontSize: 13, color: COLORS.textMuted, fontFamily: "'DM Sans', sans-serif", lineHeight: 1.6 }}>
                  Open to remote positions nationwide and on-site roles in the greater Ohio area.
                </div>
              </div>
            </div>
          </FadeIn>
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                ...
                <div>
                  ...
                  <input type="text" placeholder="What's this about?" value={form.subject} onChange={updateField("subject")} style={INPUT_STYLE} onFocus={focusBorder} onBlur={blurBorder} />
                </div>
                ...
                {status === "error" && (
                  <div style={{ fontSize: 13, color: "#dc2626", fontFamily: "'DM Sans', sans-serif" }}>
                    Please fill in all required fields.
                  </div>
                )}
                {status === "sent" && (
                  <div style={{ fontSize: 13, color: "#16a34a", fontFamily: "'DM Sans', sans-serif" }}>
